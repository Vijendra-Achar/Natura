...
// Function to make the API call and log the user in
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logged in Successfully! Please Wait...');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'There was an Error logging out! Please Try again...');
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"environment.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.stripePublicKey = exports.mapboxAccessToken = void 0;
var mapboxAccessToken = 'pk.eyJ1IjoidmlqZW5kcmFjaGFyIiwiYSI6ImNraDcyaWUxdzBoeDUycG56ano5bHR5Z2kifQ.ccHbOExocP4G_2cJabutbg';
exports.mapboxAccessToken = mapboxAccessToken;
var stripePublicKey = 'pk_test_51HqefwKhpMa58yrgimLc7o65pH7KfPXH6fhgYF2N51cfges4zA9CtmX4Bp8CU68f2ufbtxxpgkDQqIlrF32IEyjl009ILCzKRO';
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = _environment.mapboxAccessToken;
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; // Insert the marker on the map

    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // Insert Popup

    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extend the bounds of the map
...
},{"./environment":"environment.js"}],"stripe.js":[function(require,module,exports) {
"use strict";
...
var stripe = Stripe(_environment.stripePublicKey);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "/api/v1/booking/checkout/".concat(tourId)
            });
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","./environment":"environment.js"}],"accountSettings.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            (0, _alerts.showAlert)('success', 'Your details were updated successfully!');
            window.setTimeout(function () {
              location.reload();
            }, 1500);
            _context.next = 12;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 8;
              return (0, _accountSettings.updateInfo)(form);
